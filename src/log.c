/*
    I copied this in its entirety from BBFS.
*/
...
void log_fuse_context(struct fuse_context *context)
{
    ...
    log_struct(((struct my_state *)context->private_data), logfile, % 08x, );
    log_struct(((struct my_state *)context->private_data), rootdir, % s, );
